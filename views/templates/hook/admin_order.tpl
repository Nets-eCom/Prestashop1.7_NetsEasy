					...
					<div class="nets-block">
						<table cellspacing="0" cellpadding="0" border="0" width="100%">
							<thead>
								...
								<tr>
									...
									<th>{l s="nets_product" d="Modules.Netseasy.Admin_content_order"}</th>
										{if $data.responseItems.failedItems || $data.responseItems.cancelledItems || $data.responseItems.refundedItems}
							...
							<tbody>
								...
								<!-- Reserved Payment -->
								{if $data.responseItems.reservedItems != $data.responseItems.cancelledItems}
							...
							{if $data.responseItems.refundedItems and $data.status.payStatus == "Refunded"} 								 
							...
							{if $data.responseItems.cancelledItems} 								 
							...
							{if $data.responseItems.failedItems} 								 
